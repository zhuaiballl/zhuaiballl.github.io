...
export default {
   ...
   */
  title: 'zhuaiballl',
  subtitle: 'zhuai ball l',

  /**
   * Github Issues 配置
   */
  username: 'zhuaiballl', // github 用户名
  repository: 'blog', // 文章仓库地址
  token: ['ghp_TMG1vLfAggygx', 'yCgMkvE94k04yGBed0QkPA2'], // token 从中间任意位置拆开成两部分，避免 github 代码检测失效

  /**
   * Gitalk 配置，文档详见：https://github.com/gitalk/gitalk
   */
  gitalk: {
    clientID: '2750c9edc643950db758',
    clientSecret: '4d7fc6b4494e5d4f5c37d28dece8bc11b56206dd',
    repo: 'comment', // 评论仓库地址
    owner: 'zhuaiballl',
    admin: ['zhuaiballl'],
   ...
   */
  leancloud: {
    appId: 'RNS2R9ilhztnosHNSV0Gaq1G-MdYXbMMI',
    appKey: 'tiAtOcwUlaR8faUVcVi1YEu5',
  },
